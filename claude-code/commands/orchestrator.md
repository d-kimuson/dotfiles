...
Task(
  ...
  prompt: "Analyze bundle size in src/ directory. Return bundle analysis with top 10 largest files and optimization recommendations (150 words max)"
)

Task(
  description: "Component performance audit",
  prompt: "Audit performance in src/components/ directory. Identify components with >100ms render time and memory leaks. Return prioritized list (150 words)"
)
