...
function pi-mid() {
  srtx -- pi --models 'opencode-go/deepseek-v4-flash,openai-codex/gpt-5.4,openai-codex/gpt-5.3-codex-spark' --thinking low "$@"
}

function pi-high() {
  srtx -- pi --models 'openai-codex/gpt-5.5,opencode-go/deepseek-v4-flash' --thinking medium "$@"
}
